...
<html lang="en">
  ...
  <body>
    ...
    <main>
      ...
      <div class="Terminal-form" style="width: 150px">
        <div class="card">
          <h4 style="padding-top: 10px; text-align: center">
            <strong>Terminal Debugger</strong>
          </h4>
          <div
            style="
              padding-left: 10px;
          ...
          >
            <button class="btn btn-primary" type="button" onclick="sendata();">
              Send Data
            </button>
            <input
              type="text"
          ...
          >
            <textarea
              ...
              style="height: 300px"
            ></textarea>
            <label for="floatingTextarea2">Device Logs</label>
    ...
    <script>
      ...
      function onMessage(event) {
        if (event.data) {
          if (arduinoData) {
            arduinoData = arduinoData.concat("&#13;&#10;", event.data);
            document.getElementById("terminal").innerHTML = arduinoData;
      ...
      function sendata() {
        var terminalData = document.getElementById("uartCommand").value;
        websocket.send(terminalData);
      }
    </script>
  </body>
</html>
